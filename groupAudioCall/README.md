# PlanetKit quick start for Android (Group Audio Call)
...
- [API Reference](https://docs.lineplanet.me/api-reference/client/android/6.0/index.html)
...
> To ensure compatibility and proper functionality, you must install Android Studio version Koala or later to support API Level 35. For more information, see [Minimum versions of tools for Android API level](https://developer.android.com/build/releases/gradle-plugin#api-level-support).

- Android SDK Platform 35
  - The `targetSdkVersion` and `compileSdkVersion` of this quick start project is 35. So, the installation of Android SDK Platform 35 is required.
  - Open any folder in Android Studio and check the installation status of Android SDK Platform 35 as shown in the following screenshot (**Tools > SDK Manager**). If it is not installed yet, select "Android SDK Platform 35" and click **Apply** to proceed with the installation.

    <img width="700px" src="../images/sdkmanager_35.png"/>

- Configure on-device developer options
  - To enable communication between your Android device and your build machine when using a real device, follow the 2 steps below:
    - [Enable Developer options](https://developer.android.com/studio/debug/dev-options?utm_source=chatgpt.com#enable)
    - [Enable USB debugging](https://developer.android.com/studio/debug/dev-options?utm_source=chatgpt.com#Enable-debugging)
...
<img width="700px" src="../images/open_project.png"/>
...
> Note: The microphone does not work on the Android emulator. Be sure to test your code on a real device. For more information, see [MediaRecorder](https://developer.android.com/media/platform/mediarecorder).

Select `groupAudioCall` project and then run the `groupAudioCall` project on an Android device.

<img width="700px" src="../images/groupAudioCall/select_project.png"/>
...
<img width="700px" src="../images/groupAudioCall/join_group_audio_call.png"/>

Once you're connected to the call, you can communicate with other participants. Click **Leave** to leave the group call.

<img width="700px" src="../images/groupAudioCall/connected_group_audio_call.png"/>
...
<img width="700px" src="../images/android_studio_installation_error.png"/>
...
If you encounter Gradle sync issues related to Android Gradle plugin (AGP) versions like the following screenshot, you must upgrade your Android Studio to version Koala or later.

<img width="700px" src="../images/groupAudioCall/android_studio_agp_error.png"/>

### Call connection issues

If the group call cannot be connected, please check [PlanetKitStartFailReason](https://docs.lineplanet.me/api-reference/client/android/6.0/planet/com.linecorp.planetkit/-planet-kit-start-fail-reason/index.html) and [PlanetKitDisconnectReason](https://docs.lineplanet.me/android/reference/disconnect-reason).

```kotlin
// check PlanetKitStartFailReason
// GroupAudioMainActivity.kt
