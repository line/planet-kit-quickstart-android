...
class GroupVideoNotificationService : NotificationService() {
    ...
    companion object {
        ...
        private fun startServiceWithAction(context: Context, action: String) {
            val intent = Intent(context, GroupVideoNotificationService::class.java).apply {
                this.action = action
            }
    ...
    override val notificationId: Int = 301
    override val channelId: String = "GROUP_VIDEO_ONGOING_CHANNEL_ID"
    override val channelName: String = "Group Video Call in Progress"

    override fun createNotification(): Notification {
        return buildNotification(GroupVideoCallActivity::class.java, R.mipmap.ic_launcher)
    }
}
