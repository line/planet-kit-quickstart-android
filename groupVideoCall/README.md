# PlanetKit quick start for Android (Group Video Call)
...
Select `groupVideoCall` project and then run the `groupVideoCall` project on an Android device.

<img width="700px" src="../images/groupVideoCall/select_project.png"/>
...
<img width="700px" src="../images/groupVideoCall/join_group_video_call.png"/>

Once you're connected to the call, you can communicate with other participants.

<img width="700px" src="../images/groupVideoCall/connected_group_video_call.png"/>
